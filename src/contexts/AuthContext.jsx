...
// Hàm tiện ích để lấy userData từ Local Storage
const getStoredUser = () => {
    ...
    if (userDataString) {
        try {
            ...
            console.error("Lỗi parse userData từ Local Storage:", error);
            return null;
        }
    }
    return null;
...
export const AuthProvider = ({ children }) => {
    ...
    const logout = () => {
        ...
        localStorage.removeItem('userData'); // Xóa cả data người dùng
